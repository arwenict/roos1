...
<link href='<?php echo $this->baseurl ?>/custom_lib/shared/css/multi-select.css' rel='stylesheet' type='text/css' />
...
<script type="text/javascript" src="<?php echo $this->baseurl ?>/custom_lib/shared/js/jquery.multi-select.js"></script>