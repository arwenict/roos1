<?php /**  * @copyright	Copyright (C) 2012 Template - All Rights Reserved. **/
...
<div id="bottom">
    ...
    <div class="tg">	
			...
			<?php if ($this->params->get( 'jcopyright' )) : ?><div class="panelz">By <a href="http://www.toponlinepoker.org" title="toponlinepoker.com" target="_blank">top online poker sites</a></div><p class="flip">&copy;</p><?php endif; ?>
	</div>
</div></div></div>
