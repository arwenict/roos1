...
<!-- End -->	
	...
	<?php if ($this->params->get( 'footerdisable' )) : ?><?php echo ($footertext); ?><?php endif; ?>. Thanks to <a href="http://www.toponlinepoker.org" title="toponlinepoker" target="_blank">Best online poker sites</a> - All rights reserved. 
	</div>
</div> 
</body>
</html>