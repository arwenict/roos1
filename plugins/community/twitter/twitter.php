...
if(!class_exists('plgCommunityTwitter'))
{
	class plgCommunityTwitter extends CApplications
	{
		...
		function onProfileDisplay()
		{
			...
			$css		= ( C_JOOMLA_15 ) 
						? JURI::base() . 'plugins/community/twitter/style.css' 
						: JURI::base() . 'plugins/community/twitter/twitter/style.css';
            		...
            		<ul>
           				<li>
							...
							<div class="twitter-user-avatar">
								<a href="http://twitter.com/<?php echo $userinfo->screen_name; ?>" target="blank"><img class="cAvatar" src="<?php echo $userinfo->profile_image_url; ?>" alt="<?php echo $userinfo->screen_name; ?>"/></a>
							</div>
							<!--end twitter avatar-->
							<!--start twitter post-->
