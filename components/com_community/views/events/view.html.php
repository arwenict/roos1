...
class CommunityViewEvents extends CommunityView
{
	...
	public function display($tpl = null)
	{
		...
		$eventparent = JRequest::getVar('parent','', 'GET');
	...
	**/
	...
	public function _displayForm($event)
	{
		...
		//$cTree	= JCCModel::getAllUsers($users);
		
		//$lists['instructorid']	=   CCategoryHelper::getSelectList( 'events', $cTree, $event->instructorid );
	...
	public function _getEventsHTML( $eventObjs, $isExpired = false, $pagination = NULL)
	{
		...
		$tmpl	=   new CTemplate();
		return $tmpl	->set( 'showFeatured'	    , $config->get('showfeaturedevents') )
