					...
					$f = JArrayHelper::toObject ( $f );
                                        ...
                                        if ($f->name == "Locations") {
                                            ...
                                            foreach($studios as $studio) {
                                                ...
                                                $options .= "<input style='margin-right:10px;' onchange='javascript:saveLocations()' type='checkbox' original-title='Which club locations are preferred by instructor' $checked class='field22' value='{$studio['nodeID']}' />{$studio['displayCode']}<br />";
                                            }
                                            echo "
                                                <tr> 
                                                    <td class='key'>
