...
<?php } ?>
	...
	<tr>
		...
		<select name="location" id="location" type="text" maxlength="255" class="required inputbox jomNameTips">
		<option value="Hero 48 Druitt Street  Sydney NSW 2000">Hero</option>
		<option value="Mountain 48 Druitt Street  Sydney NSW 2000">Mountain</option>
		<option value="Reformer 48 Druitt Street  Sydney NSW 2000">Reformer</option>
		<option value="Firefly 48 Druitt Street  Sydney NSW 2000">Firefly</option>
		<option value="Cobra 48 Druitt Street  Sydney NSW 2000">Cobra</option>
		<option value="Warrior 48 Druitt Street  Sydney NSW 2000">Warrior</option>
		<option value="Rooftop 48 Druitt Street  Sydney NSW 2000">Rooftop or boxing</option>
		</select>		
...
-->
	...
	<tr>
		...
		<select name="instructorID" id="instructorID" type="text" maxlength="255" class="required inputbox jomNameTips">
		<option value="400">Chris</option>
		<option value="401">John</option>
		<option value="402">Madona</option>
		</select>		
