		...
		<td class="value">
			...
			<span class="jomNameTips" title="<?php echo JText::_('COM_COMMUNITY_EVENTS_LOCATION_TIPS');?>"><?php 
				...
				<select name="location" id="location">
				     ...
				     <option value="<?php echo $row[$ii][0];?>"<?php echo $event->location == $row[$ii][2] ? ' selected="selected"' : '';?>><?php echo $row[$ii][1]; ?></option>
	...
	<tr>			
		<td class="key">
			...
			<span class="jomNameTips" title="<?php echo JText::_('Please enter the Hourly Rate in AUD');?>"><?php 
				...
				<input name="HourlyRate" title="<?php echo JText::_('Please enter the Hourly Rate in AUD'); ?>" id="HourlyRate" min="0" max="99999" step="1" size="5"
