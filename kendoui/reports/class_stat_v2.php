	...
	<script>
		...
		$(document).ready(function() {
			...
			$("#grid").kendoGrid({
				...
				{ field: "HourlyRate", title: "Hourly Rate", format: "{0:C2}", width: "70" , aggregates: "average", footerTemplate: "Average: #=average#", groupFooterTemplate: "Average: #=average#"}, 
				{ field: "TotalPayable", title: "Total Payable", format: "{0:C2}", width: "70", aggregates: "sum", footerTemplate: "<div>Total: #=sum#</div>", groupFooterTemplate: "Subtotal: #=sum#"},
